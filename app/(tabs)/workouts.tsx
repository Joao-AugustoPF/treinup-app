              ...
              workouts.map((workout) => (
                ...
                >
                  ...
                  <View style={styles.workoutContent}>
                    <View>
                      <Text style={[styles.workoutName, { color: '#FFFFFF' }]}>
                        {workout.name}
                      </Text>
                      <Text style={[styles.workoutFocus, { color: '#FFFFFF' }]}>
                        {workout.focus}
                      </Text>
                    </View>
                    <View
                    ...
                    >
                      <Text
                        style={[styles.exerciseCountText, { color: '#FFFFFF' }]}
                      >
                        ...
                        >
                          ...
                          <View style={styles.exerciseDetails}>
                            ...
                            <View style={styles.restContainer}>
                              ...
                              />
                              <Text
                                style={[styles.restText, { color: '#666666' }]}
                              >
