...
function generateRandomValue(type: string): number {
  switch (type) {
    ...
    case 'waist_circ':
      return faker.number.float({ min: 60, max: 120, precision: 0.1 });
    case 'hip_circ':
      return faker.number.float({ min: 80, max: 140, precision: 0.1 });
    case 'wh_ratio':
      return faker.number.float({ min: 0.6, max: 1.2, precision: 0.01 });
    case 'chest_circ':
      return faker.number.float({ min: 80, max: 140, precision: 0.1 });
    case 'arm_circ':
      return faker.number.float({ min: 25, max: 45, precision: 0.1 });
    case 'thigh_circ':
      return faker.number.float({ min: 40, max: 80, precision: 0.1 });
    case 'calf_circ':
      return faker.number.float({ min: 30, max: 50, precision: 0.1 });
    case 'rest_hr':
    ...
    case 'height':
      return faker.number.float({ min: 150, max: 200, precision: 0.1 });
    case 'body_temp':
      return faker.number.float({ min: 36.1, max: 37.2, precision: 0.1 });
    default:
      return 0;
  }
}
