...
const endpoint = 'http://http://172.20.10.12/:7001/v1';
...
const MEMBER_USER_ID = '68266a7890ef86960e2c'; // Substitua pelo ID do perfil do usuário
const MEMBER_PROFILE_ID = '68266a7b000cde5c80b5'; // Substitua pelo ID do perfil do usuário
