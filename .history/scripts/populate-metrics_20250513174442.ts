...
function generateRandomValue(type: string): number {
  switch (type) {
    case 'weight':
      return faker.number.float({ min: 50, max: 120, precision: 0.1 });
    case 'body_fat_pct':
      return faker.number.float({ min: 5, max: 40, precision: 0.1 });
    case 'lean_mass_pct':
      return faker.number.float({ min: 60, max: 95, precision: 0.1 });
    case 'bmi':
      return faker.number.float({ min: 18.5, max: 35, precision: 0.1 });
    case 'muscle_mass':
      return faker.number.float({ min: 30, max: 50, precision: 0.1 });
    case 'bone_mass':
      return faker.number.float({ min: 2, max: 5, precision: 0.1 });
    case 'body_water_pct':
      return faker.number.float({ min: 45, max: 65, precision: 0.1 });
    case 'bmr':
      return faker.number.float({ min: 1200, max: 2500, precision: 1 });
    case 'metabolic_age':
