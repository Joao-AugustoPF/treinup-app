...
export class ProfileService {
  static async getUserProfile(user: User | null): Promise<UserProfile> {
  ...
  static async updateProfile(user: User | null, updates: Partial<UserProfile>): Promise<UserProfile> {
  ...
  static async uploadProfilePhoto(user: User | null, photoURL: string): Promise<UserProfile> {
  ...
  static async initiatePasswordReset(user: User | null): Promise<void> {
    await new Promise(resolve => setTimeout(resolve, 800));
  ...
  static async deleteAccount(user: User | null): Promise<void> {
