...
export class ProfileService {
    ...
    try {
      ...
      return {
        ...
        preferences: {
          ...
          autoUpdate: updatedProfile.pref_autoUpdate !== false,
          showNotificationIcon: updatedProfile.pref_showNotificationIcon !== false,
          language: updatedProfile.pref_language || 'Português',
        },
        privacy: {
          publicProfile: updatedProfile.privacy_publicProfile !== false,
          showWorkouts: updatedProfile.privacy_showWorkouts !== false,
          showProgress: updatedProfile.privacy_showProgress === true,
          showClasses: updatedProfile.privacy_showClasses !== false,
          showEvaluation: updatedProfile.privacy_showEvaluation !== false,
          twoFactorAuth: updatedProfile.privacy_twoFactorAuth === true,
        },
      };
    } catch (error) {
  ...
  static async updateUserAvatar(user: any, avatarUrl: string): Promise<UserProfile> {
    return this.updateProfile(user, { avatarUrl });
  }

  static async updatePreferences(user: any, preferences: Partial<UserProfile['preferences']>): Promise<UserProfile['preferences']> {
