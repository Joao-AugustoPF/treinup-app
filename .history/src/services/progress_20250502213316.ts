...
export class ProgressService {
  static async getUserAssessments(user: User | null, gymId: string): Promise<Assessment[]> {
  ...
  static async getLatestAssessment(user: User | null, gymId: string): Promise<Assessment> {
  ...
  static async getProgressStats(user: User | null, gymId: string): Promise<{
    weightChange: number;
