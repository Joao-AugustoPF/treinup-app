  ...
  static async getUserWorkouts(
    ...
    try {
      ...
      try {
        ...
        // Em vez de listar todas as coleções, vamos apenas registrar as que conhecemos
        console.log('[WorkoutService] Known Collections:', { 
          workouts: WORKOUTS_COLLECTION_ID, 
          exercises: EXERCISES_COLLECTION_ID, 
          workoutSets: WORKOUT_SETS_COLLECTION_ID 
        });
      } catch (e) {
        console.error('[WorkoutService] Error logging collections:', e);
      }
