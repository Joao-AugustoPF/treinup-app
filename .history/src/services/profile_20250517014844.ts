  ...
  static async getUserProfile(user: any | null): Promise<UserProfile> {
    ...
    try {
      ...
      return {
        ...
        addressStreet: profileDoc.address_street || '',
        addressNumber: profileDoc.address_number || '',
        addressComplement: profileDoc.address_complement || '',
        addressCity: profileDoc.address_city || '',
        addressState: profileDoc.address_state || '',
        addressZip: profileDoc.address_zip || '',
        stats: {
    ...
    try {
      ...
      if (contactInfo.address !== undefined) {
        if (contactInfo.address.street !== undefined)
          updateData.address_street = contactInfo.address.street;
        if (contactInfo.address.number !== undefined)
          updateData.address_number = contactInfo.address.number;
        if (contactInfo.address.complement !== undefined)
          updateData.address_complement = contactInfo.address.complement;
        if (contactInfo.address.city !== undefined)
          updateData.address_city = contactInfo.address.city;
        if (contactInfo.address.state !== undefined)
          updateData.address_state = contactInfo.address.state;
        if (contactInfo.address.zip !== undefined)
          updateData.address_zip = contactInfo.address.zip;
      }
