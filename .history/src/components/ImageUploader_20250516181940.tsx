...
export default function ImageUploader({
  ...
  const takePhoto = async () => {
    try {
      ...
      await processAndUploadImage(imageAsset);
    } catch (error) {
  ...
  const processAndUploadImage = async (asset: ImagePickerAsset) => {
    try {
      const context = ImageManipulator.useImageManipulator(asset.uri);
