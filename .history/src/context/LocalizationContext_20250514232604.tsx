...
const translations = {
  en: {
    ...
    selectMeasurement: 'Select Measurement Type',
    value: 'Value',
    date: 'Date',
    save: 'Save',
    ...
    noClassesBooked: "You haven't booked any classes yet",
    ...
    schedule: 'Schedule',
    noEvaluationsScheduled: 'No evaluations scheduled',
    ...
    confirm: 'Confirm',
    evaluationScheduled: 'Evaluation scheduled successfully',
    cancelEvaluation: 'Cancel Evaluation',
  ...
  pt: {
    ...
    selectMeasurement: 'Selecionar Tipo de Medida',
    value: 'Valor',
    date: 'Data',
    save: 'Salvar',
    ...
    scheduledWorkouts: 'Treinos Agendados',
    ...
    bookedClasses: 'Aulas Reservadas',
    noClassesAvailable: 'Nenhuma aula disponível',
    noClassesBooked: 'Você ainda não reservou nenhuma aula',
    ...
    full: 'Lotada',
    classBooked: 'Aula reservada com sucesso',
    ...
    schedule: 'Agendar',
    noEvaluationsScheduled: 'Nenhuma avaliação agendada',
    ...
    confirm: 'Confirmar',
    evaluationScheduled: 'Avaliação agendada com sucesso',
    cancelEvaluation: 'Cancelar Avaliação',
    evaluationCancelled: 'Avaliação cancelada',
  },
};
