...
const translations = {
  en: {
    ...
    notNow: 'Not now',
    install: 'Install',
    updateDownloaded: 'Update downloaded. The app will restart to apply changes.',
    ...
    failedToCheck: 'Failed to check for updates. Check your internet connection.',
  ...
  pt: {
    ...
    // Update checking
    updateUnavailable: 'Verificação de atualizações indisponível no modo de desenvolvimento.',
    updateAvailable: 'Atualização Disponível',
    installNow: 'Uma nova versão está disponível. Deseja instalar agora?',
    notNow: 'Agora não',
    install: 'Instalar',
    updateDownloaded: 'Atualização baixada. O aplicativo será reiniciado para aplicar as mudanças.',
    failedToDownload: 'Falha ao baixar atualização. Tente novamente mais tarde.',
    upToDate: 'Atualizado',
    usingLatestVersion: 'Você está usando a versão mais recente do aplicativo.',
    failedToCheck: 'Falha ao verificar atualizações. Verifique sua conexão com a internet.',
    ...
    resetLinkSent: 'Um link para redefinir sua senha foi enviado para seu endereço de email.',
...
export function LocalizationProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <LocalizationContext.Provider value={{ t, language, setLanguage, isLoading }}>
      {children}
