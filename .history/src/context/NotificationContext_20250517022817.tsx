...
import { Notification as AppwriteNotification, NotificationService } from '@/src/services/notification';
...
export function NotificationsProvider({ children }: { children: React.ReactNode }) {
  ...
  const mapAppwriteNotification = (notification: AppwriteNotification): Notification => ({
    id: notification.id,
  ...
  useEffect(() => {
    if (user?.$id) {
      ...
      const unsubscribe = client.subscribe(
        `databases.treinup.collections.68281a17001502a83bd4.documents`,
