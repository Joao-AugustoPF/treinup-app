      ...
      >
        <View style={styles.postHeader}>
          ...
          <View style={styles.userInfo}>
            <Text
              style={[styles.userName, { color: paperTheme.colors.onSurface }]}
            >
              {post.author.name}
            </Text>
            <View style={styles.badgeContainer}>
              ...
              <Text
                style={[styles.badgeText, { color: paperTheme.colors.primary }]}
              >
                {post.author.role}
              </Text>
            </View>
        ...
        <Text
          style={[styles.postContent, { color: paperTheme.colors.onSurface }]}
        >
          {post.content}
        </Text>
        {post.mediaUrl && (
