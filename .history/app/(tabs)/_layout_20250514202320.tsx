    ...
    <View style={{ flex: 1 }}>
      <Tabs
        screenOptions={{
          ...
          tabBarInactiveTintColor: 'transparent', // cor transparente para o label “fantasma”
          tabBarShowLabel: true, // a gente mesmo controla o label na função abaixo
        ...
        {visibleTabs
          ...
          .map((tab) => (
            <Tabs.Screen
              ...
              name={tab.name}
              options={{
                // desenha o ícone SÓ quando estiver focused
                tabBarIcon: ({ focused, color, size }) =>
                  focused ? tab.icon({ size, color }) : null,

                // desenha o label SÓ quando estiver focused
