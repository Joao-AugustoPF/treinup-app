...
export default function ProgressScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: paperTheme.colors.background }]}>
      <ScrollView>
        <View style={[styles.hero, { backgroundColor: paperTheme.colors.surface }]}>
        ...
        <View style={styles.content}>
          {metricGroups.length === 0 ? (
            <View style={[styles.noDataContainer, { backgroundColor: paperTheme.colors.surface }]}>
            ...
            <>
              <View style={[styles.dateRangeContainer, { backgroundColor: paperTheme.colors.surface }]}>
                <Text style={[styles.dateRangeText, { color: paperTheme.colors.primary }]}>
                  Dados de {metricGroups[0].date.toLocaleDateString('pt-BR')} até{' '}
                  {metricGroups[metricGroups.length - 1].date.toLocaleDateString('pt-BR')}
                </Text>
              </View>

              <View style={styles.metricsGrid}>
                {metrics.map((metric) => (
                  <View key={metric.title} style={[styles.metricCard, { backgroundColor: paperTheme.colors.surface }]}>
                    <View style={styles.metricHeader}>
                      <metric.icon size={24} color={paperTheme.colors.primary} />
                      <Text style={[styles.metricTitle, { color: paperTheme.colors.onSurfaceVariant }]}>
                        {metric.title}
                      </Text>
                    </View>
                    ...
                    >
                      <Text style={[styles.changeText, { color: paperTheme.colors.onSurface }]}>
                        {Number(metric.change) > 0 ? '+' : ''}
                        {metric.change}%
                      </Text>
                    </View>
              ...
              <View style={styles.section}>
                ...
                <View style={[styles.chartCard, { backgroundColor: paperTheme.colors.surface }]}>
                  <View style={styles.legendContainer}>
                    <View style={styles.legendItem}>
                      ...
                      />
                      <Text style={[styles.legendText, { color: paperTheme.colors.onSurfaceVariant }]}>
                        Peso (kg)
                      </Text>
                    </View>
                    <View style={styles.legendItem}>
                  ...
                  <View style={{ width: chartWidth, alignSelf: 'center' }}>
                    <LineChart
                      ...
                      hideRules
                      focusEnabled
                      spacing={weightData.length <= 2 ? 100 : chartWidth / (weightData.length - 1)}
                      initialSpacing={weightData.length <= 2 ? 50 : 0}
                      endSpacing={weightData.length <= 2 ? 50 : 0}
                      xAxisLabelTextStyle={{ color: paperTheme.colors.onSurfaceVariant, fontSize: 10 }}
                      yAxisTextStyle={{ color: paperTheme.colors.onSurfaceVariant, fontSize: 10 }}
                ...
                <View style={[styles.chartCard, { backgroundColor: paperTheme.colors.surface }]}>
                  {getCategoryMetrics(selectedCategory).map((metric) => (
                    <View key={metric.type} style={styles.detailedMetricRow}>
                      <Text style={[styles.detailedMetricLabel, { color: paperTheme.colors.onSurface }]}>
                        {metric.label}
                      </Text>
                      <Text style={[styles.detailedMetricValue, { color: paperTheme.colors.onSurface }]}>
              ...
              <View style={styles.section}>
                ...
                <View style={[styles.chartCard, { backgroundColor: paperTheme.colors.surface }]}>
                  <BarChart
                    ...
                    maxValue={10000}
                    hideRules={false}
                    xAxisLabelTextStyle={{ color: paperTheme.colors.onSurfaceVariant }}
                    yAxisTextStyle={{ color: paperTheme.colors.onSurfaceVariant }}
                  ...
                  {bodyMeasurements && (
                    <View style={styles.measurementsContainer}>
                      ...
                      <View style={styles.measurementsTable}>
                        <View style={[styles.tableHeader, { borderBottomColor: paperTheme.colors.surfaceVariant }]}>
                          <Text style={[styles.tableHeaderText, { color: paperTheme.colors.onSurfaceVariant }]}>
                            Medida
                          </Text>
                          <Text style={[styles.tableHeaderText, { color: paperTheme.colors.onSurfaceVariant }]}>
                            Inicial
                        ...
                        {bodyMeasurements.labels.map((label, index) => {
                          ...
                          return (
                            <View key={label} style={[styles.tableRow, { borderBottomColor: paperTheme.colors.surfaceVariant }]}>
                              <Text style={[styles.tableCellText, { color: paperTheme.colors.onSurface }]}>
                                {label}
                              </Text>
                              <Text style={[styles.tableCellText, { color: paperTheme.colors.onSurface }]}>
                                {initialValue} cm
                        ...
                        {bodyMeasurements.labels.map((label, index) => {
                          ...
                          return (
                            <View key={label} style={styles.measurementBarGroup}>
                              <Text style={[styles.measurementBarLabel, { color: paperTheme.colors.onSurface }]}>
                                {label}
                              </Text>
                  ...
                  <View style={styles.pieChartContainer}>
                    <PieChart
                      data={pieChartData.map(item => ({
                        ...item,
                        color: item.legend === 'Massa Magra' ? paperTheme.colors.primary : paperTheme.colors.error
                      }))}
                      radius={120}
                      showText
                      ...
                      centerLabelComponent={() => (
                        <View style={styles.pieChartCenter}>
                          <Text style={[styles.pieChartCenterText, { color: paperTheme.colors.onSurface }]}>
                            {latestMetrics.weight !== undefined ? `${latestMetrics.weight}kg` : ''}
                          </Text>
                          <Text style={[styles.pieChartCenterSubtext, { color: paperTheme.colors.onSurfaceVariant }]}>
                            Peso Atual
                          </Text>
                        </View>
                      )}
                    ...
                    {pieChartData.map((item, index) => (
                      <View key={index} style={styles.legendItem}>
                        <View
                          style={[
                            styles.legendColor,
                            { backgroundColor: item.legend === 'Massa Magra' ? paperTheme.colors.primary : paperTheme.colors.error },
                          ]}
                        />
                        <Text style={[styles.legendText, { color: paperTheme.colors.onSurfaceVariant }]}>
