...
export default function ScheduleScreen() {
    ...
    return (
      <View style={[styles.container, { backgroundColor: paperTheme.colors.background }]}>
        <View style={[styles.header, { backgroundColor: paperTheme.colors.surface }]}>
          <Text style={[styles.title, { color: paperTheme.colors.onSurface }]}>Avaliações Físicas</Text>
          <Text style={[styles.subtitle, { color: paperTheme.colors.onSurfaceVariant }]}>
            Agende e gerencie suas avaliações físicas
          </Text>
          <TouchableOpacity
            style={[styles.newButton, { backgroundColor: paperTheme.colors.primary }]}
            onPress={() => setShowNewSchedule(true)}
          >
            <Calendar size={16} color={paperTheme.colors.onPrimary} />
            <Text style={[styles.newButtonText, { color: paperTheme.colors.onPrimary }]}>
              Nova Avaliação
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <ScrollView style={styles.content}>
          {schedules.length === 0 ? (
            <View style={[styles.emptyState, { backgroundColor: paperTheme.colors.surface }]}>
              <Image
              ...
              <Text style={[styles.emptyText, { color: paperTheme.colors.onSurfaceVariant }]}>
                Agende sua primeira avaliação física para acompanhar seu progresso
              </Text>
            </View>
          ) : (
            <View>
              <TouchableOpacity
                ...
                style={[styles.sectionHeader, { backgroundColor: paperTheme.colors.surface }]}
              >
                <Calendar size={20} color={paperTheme.colors.primary} />
                <Text style={[styles.sectionTitle, { color: paperTheme.colors.onSurface }]}>
                  Próximas Avaliações
                </Text>
                <View style={[styles.countBadge, { backgroundColor: paperTheme.colors.primary }]}>
                  <Text style={[styles.countText, { color: paperTheme.colors.onPrimary }]}>
                    {schedules.filter((s) => s.status === 'booked' && new Date(s.date) >= new Date()).length}
                  </Text>
                </View>
                <View style={{ flex: 1 }} />
                <Animated.Text
  ...
  return (
    <View style={[styles.container, { backgroundColor: paperTheme.colors.background }]}>
      <View style={[styles.bookingHeader, { backgroundColor: paperTheme.colors.surface }]}>
        <TouchableOpacity
          onPress={() => {
            setShowNewSchedule(false);
            setScheduleToReschedule(null);
        ...
        <Text style={[styles.bookingTitle, { color: paperTheme.colors.onSurface }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Calendar size={20} color="rgba(255,20,147,0.7)" />
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Clock size={20} color="rgba(255,20,147,0.7)" />
  ...
  return (
    <View
      style={[
        ...
        isHistory && historyType === 'completed' && { borderLeftColor: paperTheme.colors.secondary },
        isHistory && historyType === 'cancelled' && { borderLeftColor: paperTheme.colors.error },
      ]}
    >
      <View style={styles.scheduleCardHeader}>
        <View style={styles.dateTimeContainer}>
          <Text style={[styles.scheduleDate, { color: paperTheme.colors.onSurface }]}>
          ...
          <Text style={[styles.scheduleTime, { color: paperTheme.colors.primary }]}>
            {schedule.time}
          </Text>
        </View>

        {!isHistory && isActive && (
          <View style={[styles.statusBadge, { backgroundColor: paperTheme.colors.primaryContainer }]}>
            <Text style={[styles.statusText, { color: paperTheme.colors.onPrimaryContainer }]}>
              Agendado
            </Text>
          </View>
        )}
        ...
        {isHistory && historyType === 'completed' && (
          <View style={[styles.statusBadge, { backgroundColor: paperTheme.colors.secondaryContainer }]}>
            <Text style={[styles.statusText, { color: paperTheme.colors.onSecondaryContainer }]}>
              Realizada
            </Text>
          </View>
        )}
        ...
        {isHistory && historyType === 'cancelled' && (
          <View style={[styles.statusBadge, { backgroundColor: paperTheme.colors.errorContainer }]}>
            <Text style={[styles.statusText, { color: paperTheme.colors.onErrorContainer }]}>
              Cancelada
            </Text>
          </View>
        )}
      ...
      <View style={styles.scheduleTrainer}>
        ...
        <Text style={[styles.trainerInfoText, { color: paperTheme.colors.onSurface }]}>
          {trainerName}
        </Text>
      </View>
      ...
      {!isHistory && isActive && (
        <View style={styles.scheduleActions}>
          <TouchableOpacity
            style={[styles.actionButton, { backgroundColor: paperTheme.colors.error }]}
            onPress={() => onCancel(schedule.id)}
          >
            <CalendarX size={16} color={paperTheme.colors.onError} />
            <Text style={[styles.actionButtonText, { color: paperTheme.colors.onError }]}>
              Cancelar
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Text style={[styles.actionButtonText, { color: paperTheme.colors.onPrimary }]}>
              Reagendar
            </Text>
          </TouchableOpacity>
        </View>
