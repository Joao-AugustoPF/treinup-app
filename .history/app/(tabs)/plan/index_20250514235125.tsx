      ...
      <ScrollView style={styles.content}>
        {userPlan && (
          <View style={styles.currentPlanSection}>
            <View style={[styles.currentPlanCard, { borderColor: userPlan.color }]}>
              ...
              <View style={styles.planActions}>
                ...
                >
                  ...
                  <Text style={styles.actionButtonText}>{t('managePayment')}</Text>
                </TouchableOpacity>
              ...
              <View style={styles.transferSection}>
                ...
                >
                  ...
                  <Text style={[styles.transferButtonText, { color: '#00E6C3' }]}>
                    {t('transfer')}
                  </Text>
                </TouchableOpacity>
              </View>
