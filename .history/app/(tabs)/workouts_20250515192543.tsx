                  ...
                  <View style={styles.modalStats}>
                    <View style={styles.modalStatsRow}>
                      <View style={styles.modalStatItem}>
                        <Dumbbell size={24} color="rgba(255,20,147,0.7)" />
                      ...
                      <View style={styles.modalStatItem}>
                        <Repeat size={24} color="rgba(255,20,147,0.7)" />
                        <Text style={styles.modalStatValue}>
                    ...
                    <View style={styles.modalRestContainer}>
                      <Timer size={24} color="rgba(255,20,147,0.7)" />
                      <Text style={styles.modalRestValue}>
                        {selectedExercise.rest}
                      </Text>
                      <Text style={styles.modalRestLabel}>Descanso</Text>
                    </View>
                  </View>
                  ...
                  {selectedExercise.instructions && (
                    <View style={styles.section}>
                      <View style={styles.sectionHeader}>
                        <Info size={20} color="rgba(255,20,147,0.7)" />
