                          ...
                          return (
                            ...
                            >
                              ...
                              <View style={styles.measurementBarContainer}>
                                ...
                                >
                                  <Text style={[styles.measurementBarText, { color: paperTheme.colors.onError }]}>
                                    {initialValue}cm
                                  </Text>
                                </View>
                                <View
                                ...
                                >
                                  <Text style={[styles.measurementBarText, { color: paperTheme.colors.onPrimary }]}>
                                    {currentValue}cm
                                  </Text>
                                </View>
                              </View>
                  ...
                  <View style={styles.pieChartContainer}>
                    <PieChart
                      data={pieChartData.map((item) => ({
                        ...
                        textBackgroundColor: item.legend === 'Massa Magra' 
                          ? paperTheme.colors.primary 
                          : paperTheme.colors.error,
                      }))}
                      radius={120}
