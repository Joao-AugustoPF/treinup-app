...
export default function ClassesScreen() {
  ...
  useEffect(() => {
    if (currentGym) {
      ...
      try {
        console.log('Setting up realtime subscription for classes...');
        console.log(
        ...
        unsubscribe = client.subscribe(
          ...
          (response: RealtimeResponseEvent<any>) => {
            ...
            if (
              ...
              console.log('Change detected in classes, refreshing...');
              fetchClasses();
            }
          }
        );
        ...
        unsubscribeBookings = client.subscribe(
          `databases.${DATABASE_ID}.collections.${CLASS_BOOKINGS_COLLECTION_ID}.documents`,
          (response: RealtimeResponseEvent<any>) => {
            console.log('Realtime booking event received:', response.events);
            console.log('Change detected in bookings, refreshing classes...');
            fetchClasses();
          }
        );

        console.log('Realtime subscriptions successful');
      } catch (error) {
