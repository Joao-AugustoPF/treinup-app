      ...
      >
        <Tabs.Screen
          ...
          options={getTabOptions(
            'Aulas',
            ({ size, color }) => <Yoga size={size} color={color} />,
        ...
        <Tabs.Screen
          ...
          options={getTabOptions(
            'Treinos',
            ({ size, color }) => <ClipboardList size={size} color={color} />,
        ...
        <Tabs.Screen
          ...
          options={getTabOptions(
            'Avaliação',
            ({ size, color }) => <Calendar size={size} color={color} />,
        ...
        <Tabs.Screen
          ...
          options={getTabOptions(
            'Progresso',
            ({ size, color }) => <LineChart size={size} color={color} />,
        ...
        <Tabs.Screen
          ...
          options={getTabOptions(
            'Comunidade',
            ({ size, color }) => <Users size={size} color={color} />,
