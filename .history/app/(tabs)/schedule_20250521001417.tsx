      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Calendar size={20} color={paperTheme.colors.primary} />
            <Text style={[styles.sectionTitle, { color: paperTheme.colors.onSurface }]}>Selecionar Data</Text>
          </View>
          {dateLoading ? (
            <ActivityIndicator
              size="small"
            ...
            >
              {availableDates.length === 0 ? (
                <View style={styles.noDataContainer}>
                  <Text style={[styles.noDataText, { color: paperTheme.colors.onSurfaceVariant }]}>Nenhuma data disponível</Text>
                </View>
              ) : (
