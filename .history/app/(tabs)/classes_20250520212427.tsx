    ...
    <View style={[styles.container, { backgroundColor: paperTheme.colors.background }]}>
      ...
      >
        <View style={[styles.header, { backgroundColor: paperTheme.colors.surface }]}>
          <Text style={[styles.title, { color: paperTheme.colors.onSurface }]}>Aulas de Fitness</Text>
        ...
        <View style={styles.content}>
          ...
          >
            <TouchableOpacity
              style={[
                ...
                selectedType === 'all' && { backgroundColor: paperTheme.colors.primary },
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  selectedType === 'all' && { color: paperTheme.colors.onPrimary },
                ]}
              >
                Todas as Aulas
              </Text>
              ...
              classTypes.map((type) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.filterButton,
                    { backgroundColor: paperTheme.colors.surfaceVariant },
                    selectedType === type && { backgroundColor: paperTheme.colors.primary },
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.filterText,
                      { color: paperTheme.colors.onSurfaceVariant },
                      selectedType === type && { color: paperTheme.colors.onPrimary },
                    ]}
                  >
          ...
          <View style={styles.classesContainer}>
            {loading ? (
              ...
              <View style={[styles.noClassesContainer, { backgroundColor: paperTheme.colors.surface }]}>
                <Text style={[styles.noClassesText, { color: paperTheme.colors.onSurfaceVariant }]}>
                  Nenhuma aula disponível
                </Text>
              </View>
            ) : (
              classes.map((fitnessClass) => (
                <View key={fitnessClass.id} style={[styles.classCard, { backgroundColor: paperTheme.colors.surface }]}>
                  <View style={styles.classCardContent}>
                    <View style={styles.classInfo}>
                      <View style={styles.classTypeContainer}>
                        <ClassTypeIcon type={fitnessClass.type} />
                        <Text style={[styles.className, { color: paperTheme.colors.onSurface }]}>
                          {fitnessClass.name}
                        </Text>
                      </View>
                      ...
                      <View style={styles.detailRow}>
                        ...
                        <View style={styles.detailItem}>
                          <Text style={[styles.durationText, { color: paperTheme.colors.primary }]}>
                            {formatDuration(fitnessClass.start, fitnessClass.end)}
                          </Text>
                        </View>
                      </View>
                      ...
                      <View style={styles.detailRow}>
                        <View style={styles.detailItem}>
                          <MapPin size={14} color={paperTheme.colors.onSurfaceVariant} />
                          <Text style={[styles.detailText, { color: paperTheme.colors.onSurfaceVariant }]}>
                      ...
                      <View style={styles.detailRow}>
                        <View style={styles.detailItem}>
                          <UsersIcon size={14} color={paperTheme.colors.onSurfaceVariant} />
                          <Text style={[styles.detailText, { color: paperTheme.colors.onSurfaceVariant }]}>
                            {fitnessClass.bookingsCount}/{fitnessClass.capacity} vagas
                          </Text>
                        </View>
                        {fitnessClass.capacity - fitnessClass.bookingsCount <= 3 &&
                          fitnessClass.capacity > fitnessClass.bookingsCount && (
                            <Text style={[styles.limitedSpotsText, { color: paperTheme.colors.error }]}>
                              Restam apenas {fitnessClass.capacity - fitnessClass.bookingsCount} vagas!
                            </Text>
                          )}
                      </View>
                    </View>
                  ...
                  <View style={[styles.instructorRow, { borderTopColor: paperTheme.colors.surfaceVariant }]}>
                    <Image
                      source={{
                    ...
                    />
                    <Text style={[styles.instructorName, { color: paperTheme.colors.onSurface }]}>
                  ...
                  {fitnessClass.isCheckedIn ? (
                    <TouchableOpacity
                      style={[styles.cancelButton, { backgroundColor: paperTheme.colors.errorContainer }]}
                      onPress={() => handleCancelCheckIn(fitnessClass.id)}
                    >
                      <XCircle size={20} color={paperTheme.colors.error} />
                      <Text style={[styles.cancelButtonText, { color: paperTheme.colors.error }]}>
                        Cancelar Check-in
                      </Text>
                    </TouchableOpacity>
                  ) : (
                    <TouchableOpacity
                      style={[styles.checkInButton, { backgroundColor: paperTheme.colors.primary }]}
                      onPress={() => handleCheckIn(fitnessClass.id)}
                    >
                      <CheckCircle2 size={20} color={paperTheme.colors.onPrimary} />
                      <Text style={[styles.checkInButtonText, { color: paperTheme.colors.onPrimary }]}>
                        Fazer Check-in
                      </Text>
                    </TouchableOpacity>
                  )}
