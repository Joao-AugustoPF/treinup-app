...
export default function SettingsScreen() {
  ...
  const handleCheckUpdates = async () => {
    if (!Updates.isAvailableAsync) {
      Alert.alert('Informação', 'Verificação de atualizações indisponível no modo de desenvolvimento.');
      return;
    }
    ...
    try {
            ...
            },
            {
              ...
              onPress: async () => {
                try {
                  ...
                  Alert.alert('Erro', 'Falha ao baixar atualização. Tente novamente mais tarde.');
                }
              }
            }
          ]
      ...
      Alert.alert('Erro', 'Falha ao verificar atualizações. Verifique sua conexão com a internet.');
