  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>{t('membershipPlan')}</Text>
          <View style={styles.infoCard}>
            {userPlan ? (
              <>
                <View style={styles.infoItem}>
                  ...
                  <View style={styles.infoContent}>
                    <Text style={styles.infoLabel}>{t('planName')}</Text>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => router.push('../plan')}
                >
                  <Text style={styles.editButtonText}>{t('managePlan')}</Text>
                </TouchableOpacity>
              </>
            ) : (
              <View style={styles.noPlanContainer}>
                <Text style={styles.noPlanText}>{t('noActivePlan')}</Text>
                <TouchableOpacity
                  style={styles.editButton}
                  onPress={() => router.push('../plan')}
                >
                  <Text style={styles.editButtonText}>{t('getPlan')}</Text>
                </TouchableOpacity>
              </View>
            )}
          </View>
