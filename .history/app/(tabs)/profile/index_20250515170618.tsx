...
export default function ProfileScreen() {
  ...
  const photoActionSheetRef = useRef<ActionSheet>(null);
  ...
  const handleUploadPhoto = async () => {
    // Show action sheet with options to take photo or pick from gallery
    photoActionSheetRef.current?.show();
  };
    ...
    try {
      if (index === 0 || index === 1) {
        ...
        const permissionsGranted =
          await PhotoUploadService.requestPermissions();
        ...
        if (index === 0) {
          imageAsset = await PhotoUploadService.takePhoto();
        } else {
          imageAsset = await PhotoUploadService.pickImage();
        }
        ...
        await PhotoUploadService.uploadProfilePhoto(user, imageAsset);
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            <View style={styles.infoItem}>
              <Phone size={20} color="rgba(255,20,147,0.7)" />
            ...
            <View style={styles.infoItem}>
              <MapPin size={20} color="rgba(255,20,147,0.7)" />
              <View style={styles.infoContent}>
              ...
              >
                ...
                {item.type === 'switch' ? (
                  <Switch
                    ...
                    trackColor={{ false: '#333', true: 'rgba(255,20,147,0.7)' }}
                    thumbColor="#fff"
                  />
                ) : (
      ...
      <ActionSheet
        ref={photoActionSheetRef}
        title={t('choosePhotoSource')}
        options={[t('takePhoto'), t('chooseFromGallery'), t('cancel')]}
        cancelButtonIndex={2}
