  ...
  const loadPrivacySettings = async () => {
    try {
      ...
      if (profile && profile.privacy) {
        ...
        setShowWorkouts(profile.privacy.showWorkouts ?? true);
        setShowProgress(profile.privacy.showProgress ?? false);
        setShowClasses(profile.privacy.showClasses ?? true);
        setShowEvaluation(profile.privacy.showEvaluation ?? true);
        setTwoFactorAuth(profile.privacy.twoFactorAuth ?? false);
      }
    } catch (error) {
      Alert.alert('Erro', 'Falha ao carregar configurações de privacidade');
    } finally {
    ...
    try {
      ...
      switch (key) {
        ...
        case 'showProgress':
          ...
          break;
        case 'showClasses':
          setShowClasses(value);
          break;
        case 'showEvaluation':
          setShowEvaluation(value);
          break;
        case 'twoFactorAuth':
      ...
      items: [
        {
          ...
          value: publicProfile,
          onToggle: () => handleTogglePrivacy('publicProfile', !publicProfile),
          type: 'switch',
        },
        {
          icon: Eye,
          ...
          value: showWorkouts,
          onToggle: () => handleTogglePrivacy('showWorkouts', !showWorkouts),
          type: 'switch',
        },
        {
          icon: Calendar,
          label: 'Mostrar Aulas',
          value: showClasses,
          onToggle: () => handleTogglePrivacy('showClasses', !showClasses),
          type: 'switch',
        },
        {
          icon: BookOpen,
          label: 'Mostrar Avaliação',
          value: showEvaluation,
          onToggle: () =>
            handleTogglePrivacy('showEvaluation', !showEvaluation),
          type: 'switch',
        },
        {
          icon: Eye,
          ...
          value: showProgress,
          onToggle: () => handleTogglePrivacy('showProgress', !showProgress),
          type: 'switch',
        },
      ],
    },
      ...
      items: [
        {
          ...
          value: twoFactorAuth,
          onToggle: () => handleTogglePrivacy('twoFactorAuth', !twoFactorAuth),
          type: 'switch',
        },
        {
          icon: Key,
