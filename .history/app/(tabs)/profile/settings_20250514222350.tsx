  ...
  const loadPreferences = async () => {
    try {
      ...
      setPreferences({
        ...
        showNotificationIcon: profile.preferences.showNotificationIcon ?? true,
      });
    } catch (error) {
  ...
  const settings: SettingSection[] = [
    ...
    },
    {
      ...
      items: [
        {
          icon: Bell,
          label: 'Exibir Ícone de Notificações',
          value: preferences.showNotificationIcon,
          onToggle: () =>
            handleUpdatePreference(
              'showNotificationIcon',
              !preferences.showNotificationIcon
            ),
          type: 'switch',
        },
        {
