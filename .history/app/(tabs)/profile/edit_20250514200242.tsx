...
export default function EditProfileScreen() {
  ...
  const loadUserProfile = async () => {
    try {
      ...
      if (refreshing) {
        Alert.alert('Atualizado', 'Informações do perfil atualizadas com sucesso');
      }
    } catch (error) {
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        {refreshing && <ActivityIndicator size="small" color="#00E6C3" style={styles.headerLoader} />}
      </View>
