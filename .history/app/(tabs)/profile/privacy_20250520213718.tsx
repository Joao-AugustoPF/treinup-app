...
export default function PrivacyScreen() {
  ...
  if (privacyLoading) {
    return (
      <View style={[styles.container, styles.loadingContainer, { backgroundColor: paperTheme.colors.background }]}>
  ...
  if (error) {
    return (
      <View style={[styles.container, styles.centerContent, { backgroundColor: paperTheme.colors.background }]}>
        ...
        <TouchableOpacity style={[styles.retryButton, { backgroundColor: paperTheme.colors.primary }]} onPress={loadPrivacySettings}>
  ...
  return (
    <View style={[styles.container, { backgroundColor: paperTheme.colors.background }]}>
      <View style={[styles.header, { backgroundColor: paperTheme.colors.surface }]}>
        ...
        <Text style={[styles.title, { color: paperTheme.colors.onSurface }]}>{t('privacySettings')}</Text>
      </View>
            ...
            <View style={styles.card}>
              {section.items.map((item, index) => (
                ...
                >
                  ...
                  {item.type === 'button' && (
                    <Text style={[styles.buttonText, { color: paperTheme.colors.primary }]}>{t('change')}</Text>
                  )}
                  {item.type === 'link' && (
                    <Text style={[styles.linkText, { color: paperTheme.colors.primary }]}>{t('view')}</Text>
                  )}
                </TouchableOpacity>
              ))}
            </View>
