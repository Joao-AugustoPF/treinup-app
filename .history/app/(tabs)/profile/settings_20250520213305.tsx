  ...
  return (
    <View style={[styles.container, { backgroundColor: paperTheme.colors.background }]}>
      <View style={[styles.header, { backgroundColor: paperTheme.colors.surface }]}>
        ...
        <Text style={[styles.title, { color: paperTheme.colors.onSurface }]}>{t('appSettings')}</Text>
      </View>

      <ScrollView style={styles.content}>
        {settings.map((section) => (
          <View key={section.id} style={[styles.section, { backgroundColor: paperTheme.colors.surface }]}>
            <Text style={[styles.sectionTitle, { color: paperTheme.colors.onSurface }]}>{section.title}</Text>
              ...
              {section.items.map((item, index) => (
                ...
                >
                  <View style={styles.settingLeft}>
                    <item.icon size={20} color={paperTheme.colors.onSurfaceVariant} />
                    <Text style={[styles.settingLabel, { color: paperTheme.colors.onSurface }]}>{item.label}</Text>
                  </View>
                  {item.type === 'switch' ? (
                    <Switch
                      value={
                    ...
                    <Text style={[styles.settingValue, { color: paperTheme.colors.onSurfaceVariant }]}>{item.value}</Text>
                  ) : (
                    <View style={styles.buttonContainer}>
                      {item.isLoading ? (
                        ...
                        <Text style={[styles.buttonText, { color: paperTheme.colors.primary }]}>
      ...
      >
        <View style={[styles.modalContainer, { backgroundColor: `${paperTheme.colors.background}99` }]}>
          <View style={[styles.modalContent, { backgroundColor: paperTheme.colors.surface }]}>
            <View style={[styles.modalHeader, { borderBottomColor: paperTheme.colors.surfaceVariant }]}>
              <Text style={[styles.modalTitle, { color: paperTheme.colors.onSurface }]}>{t('selectLanguage')}</Text>
            ...
            <TouchableOpacity
              style={[styles.languageOption, { borderBottomColor: paperTheme.colors.surfaceVariant }]}
              onPress={() => handleLanguageChange('pt')}
            >
              <Text style={[styles.languageOptionText, { color: paperTheme.colors.onSurface }]}>Português</Text>
              {currentLanguage === 'pt' && (
            ...
            >
              <Text style={[styles.languageOptionText, { color: paperTheme.colors.onSurface }]}>English</Text>
              {currentLanguage === 'en' && (
                <Check size={24} color={paperTheme.colors.primary} />
              )}
            </TouchableOpacity>
