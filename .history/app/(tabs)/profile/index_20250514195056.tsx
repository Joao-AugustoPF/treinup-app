  ...
  const menuItems = [
    {
      ...
      onPress: () => router.navigate({ pathname: '/(tabs)/plan' }),
      type: 'link',
    ...
    },
    {
      ...
      onPress: () => router.navigate({ pathname: '/(tabs)/payment' }),
      type: 'link',
    },
    {
      icon: Bell,
    ...
    },
    {
      ...
      onPress: () => router.navigate({ pathname: '/(tabs)/profile/privacy' }),
      type: 'link',
    },
    {
      icon: Settings,
      label: 'App Settings',
      onPress: () => router.navigate({ pathname: '/(tabs)/profile/settings' }),
      type: 'link',
    },
  ];
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoItem}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue}>
                  {profile.location || 'Endereço não cadastrado'}
                </Text>
              </View>
            </View>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                router.navigate({ pathname: '/(tabs)/profile/edit' })
              }
            >
