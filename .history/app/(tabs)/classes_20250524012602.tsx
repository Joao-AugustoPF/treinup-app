...
const CLASS_STATUS_DISPLAY: Record<Class['status'], { label: string; color: string }> = {
                    ...
                    <View style={styles.classInfo}>
                      <View style={styles.classTypeContainer}>
                        ...
                        <View
                          style={[
                            styles.statusBadge,
                            { backgroundColor: CLASS_STATUS_DISPLAY[fitnessClass.status].color + '20' },
                          ]}
                        >
                          <Text
                            style={[
                              styles.statusText,
                              { color: CLASS_STATUS_DISPLAY[fitnessClass.status].color },
                            ]}
                          >
