...
export default function ProgressScreen() {
  ...
  const lineChartData = assessments.map((assessment) => {
  ...
  const prepareRadarData = () => {
    ...
    const initial = [
      { value: firstAssessment.measurements.chest, label: 'Peito' },
      { value: firstAssessment.measurements.waist, label: 'Cintura' },
      { value: firstAssessment.measurements.hips, label: 'Quadril' },
      { value: firstAssessment.measurements.biceps, label: 'Bíceps' },
      { value: firstAssessment.measurements.thighs, label: 'Coxa' },
    ];
    
    const current = [
      { value: currentAssessment.measurements.chest, label: 'Peito' },
      { value: currentAssessment.measurements.waist, label: 'Cintura' },
      { value: currentAssessment.measurements.hips, label: 'Quadril' },
      { value: currentAssessment.measurements.biceps, label: 'Bíceps' },
      { value: currentAssessment.measurements.thighs, label: 'Coxa' },
    ];
  ...
  const preparePieData = () => {
    ...
    return [
      { value: leanMass, color: '#00E6C3', text: `${leanMass}%`, legend: 'Massa Magra' },
      { value: bodyFat, color: '#FF4444', text: `${bodyFat}%`, legend: 'Gordura Corporal' },
    ];
  };
                ...
                <View style={styles.chartCard}>
                  ...
                  <View style={styles.polarChartContainer}>
                    <PolarChart
                      ...
                      textColor="#fff"
                      textSize={10}
                      initialColor="rgba(255, 68, 68, 0.5)"
                      chartColor="#00E6C3"
                      fillArea
                      areaOpacity={0.2}
                    />
