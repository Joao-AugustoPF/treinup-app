...
export default function ClassesScreen() {
  ...
  useEffect(() => {
    if (currentGym) {
      client.headers['X-Tenant-ID'] = currentGym.tenantId;
      fetchClasses();
    }
  ...
  const fetchClasses = async () => {
    ...
    try {
      setLoading(true);
      setError(null);
      console.log('Fetching classes for gym:', currentGym.name);
      ...
      console.error('Exception in fetchClasses:', err);
                  ...
                  <Image
                    source={{
                      uri:
                        ...
                        'https://via.placeholder.com/300/333/fff?text=Class',
                    }}
                  ...
                  <View style={styles.classContent}>
                    ...
                    <View style={styles.instructorContainer}>
                      <Image
                        source={{
                          uri:
                            fitnessClass.trainerId.imageUrl ||
                            'https://via.placeholder.com/40/333/fff?text=I',
                        }}
