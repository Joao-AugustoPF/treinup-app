            ...
            <View>
              ...
              >
                ...
                <Text style={styles.tapHint}>
                  {expandedSections.upcoming ? 'Ocultar' : 'Toque para ver'}
                </Text>
                <Animated.Text
                  style={[
              ...
              {schedules.filter(
                ...
                <>
                  ...
                  >
                    ...
                    <View style={[styles.countBadge, { backgroundColor: '#8A2BE2' }]}>
                      <Text style={styles.countText}>
                        {
                          schedules.filter(
                            (s) =>
                    ...
                    <View style={{ flex: 1 }} />
                    <Text style={[styles.tapHint, { color: '#8A2BE2' }]}>
              ...
              {schedules.filter((s) => s.status === 'cancelled').length > 0 && (
                <>
                  ...
                  >
                    ...
                    <View style={[styles.countBadge, { backgroundColor: '#FF4444' }]}>
                      <Text style={styles.countText}>
                        {schedules.filter((s) => s.status === 'cancelled').length}
                      </Text>
                    </View>
                    <View style={{ flex: 1 }} />
                    <Text style={[styles.tapHint, { color: '#FF4444' }]}>
