...
export default function NotificationsButton() {
  ...
  const buttonBg = paperTheme.colors.primary;
  const shadowColor = paperTheme.colors.primary;
  const badgeBg = paperTheme.colors.error;
  const textColor = paperTheme.colors.onPrimary;
